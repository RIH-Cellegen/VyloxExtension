...
enum Joystick_motion {LT, RT, LAXIS_UP, LAXIS_DOWN, LAXIS_LEFT, LAXIS_RIGHT, RAXIS_UP, RAXIS_DOWN, RAXIS_LEFT, RAXIS_RIGHT}
...
var joystick_motion: PackedFloat64Array = []

func apply_mouse_pressed():
...
func apply_joystick_pressed():
	...
	var array_motion: PackedFloat64Array = [Input.get_action_raw_strength("joystick_lt"), Input.get_action_raw_strength("joystick_rt"), Input.get_action_raw_strength("joystick_laxis_up"), Input.get_action_raw_strength("joystick_laxis_down"), Input.get_action_raw_strength("joystick_laxis_left"), Input.get_action_raw_strength("joystick_laxis_right"), Input.get_action_raw_strength("joystick_raxis_up"), Input.get_action_raw_strength("joystick_raxis_down"), Input.get_action_raw_strength("joystick_raxis_left"), Input.get_action_raw_strength("joystick_raxis_right")]
	if joystick_motion != array_motion:
		joystick_motion = array_motion
func apply_keyboard_pressed():
...
func get_joystick_laxis_y() -> float:
	var calc = Input.get_action_raw_strength("joystick_laxis_up") - Input.get_action_raw_strength("joystick_laxis_down")
	return 0 if calc < 0.001 and calc > -0.001 else calc
func get_joystick_laxis_x() -> float:
...
func get_joystick_laxis() -> Vector2:
	return Vector2(get_joystick_laxis_x(), get_joystick_laxis_y())
func get_joystick_raxis_y() -> float:
	var calc = Input.get_action_raw_strength("joystick_raxis_up") - Input.get_action_raw_strength("joystick_raxis_down")
	return 0 if calc < 0.001 and calc > -0.001 else calc
func get_joystick_raxis_x() -> float:
...
func get_joystick_raxis() -> Vector2:
	return Vector2(get_joystick_raxis_x(), get_joystick_raxis_y())


func _process(delta):
	apply_mouse_pressed()
	apply_keyboard_pressed()
	apply_joystick_pressed()
